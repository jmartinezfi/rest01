        ...
        if (this.element_) {
            ...
            if (this.drawer_) {
                ...
                if (!drawerButton) {
                    ...
                    //ini:modify by mpalacin 26/09/2018
                    //drawerButtonIcon.classList.add(this.CssClasses_.ICON);
                    //drawerButtonIcon.innerHTML = this.Constant_.MENU_ICON;
                    drawerButtonIcon.classList.add("fas");
                    drawerButtonIcon.classList.add("fa-bars");
                    drawerButtonIcon.innerHTML = "";
                    drawerButton.appendChild(drawerButtonIcon);
                    //fin:modify by mpalacin 26/09/2018
                }
...
/**********************************COMPONENT SELECT ADD BY MPALACIN*************************************/
...
(function() {
    ...
    MaterialSelectfield.prototype.checkDirty = function() {
    	...
    	if (this.select_.value && this.select_.value.length > 0) {
        	...
        	// ini:mpalacin
        	var vueAtr = $(this.select_).attr("vue-model");
            if(vueAtr){
               	var valCurrent = getterPath(vueAtr);
               	if (valCurrent && valCurrent.length > 0) {
                    this.element_.classList.add(this.CssClasses_.IS_DIRTY);
                    return;
               	}
            }   	
